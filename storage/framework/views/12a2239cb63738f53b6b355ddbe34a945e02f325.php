...
<?php $__env->startSection('css'); ?>
    ...
    .loader7 .loader-inner-1:before{background:#f7b84b}
    .loader7 .loader-inner-2{top:0;right:0;transform:rotate(160deg)}
    .loader7 .loader-inner-2:before{background:#f7b84b}
    .loader7 .loader-inner-3{bottom:0;right:0;transform:rotate(-110deg)}
    .loader7 .loader-inner-3:before{background:#f7b84b}
    .loader7 .loader-inner-4{bottom:0;left:0;transform:rotate(-20deg)}
    .loader7 .loader-inner-4:before{background:#f7b84b}
    @keyframes  loading-7{
...
<?php $__env->startSection('body'); ?>
    ...
    <div id="preloader" class="preloader" style="background-color: #0ab39c">
                        ...
                        <div class="col-lg-12">
                            <div class="text-center mt-sm-5 pt-0">
                                <div class="mb-5 text-white-50">
                                    ...
                                    <div class="mt-4 pt-2">
                                        <a href="<?php echo e(route('load_management_view')); ?>" class="btn rounded-pill btn-lg btn-warning btn-animation waves-effect waves-light">
                                            <i class="las la-user-tie"></i> MANAGEMENT</a>

                                        <a href="<?php echo e(route('load_stock_view')); ?>" class="btn rounded-pill btn-lg btn-warning btn-animation waves-effect waves-light">
                                            <i class="las la-user-tie"></i> STOCK MANAGEMENT</a>
        
                                        <a href="<?php echo e(route('load_appointment_view')); ?>" class="btn rounded-pill btn-lg btn-warning btn-animation waves-effect waves-light">
                                            <i class="las la-stethoscope"></i> APPOINTMENT</a>

                                        <a href="<?php echo e(route('load_cashier_view')); ?>" class="btn rounded-pill btn-lg btn-warning btn-animation waves-effect waves-light">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Intern\SAHANYA\resources\views/menu_view.blade.php ENDPATH**/ ?>