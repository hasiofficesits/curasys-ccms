            ...
            <div class="modal-content">
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-sm-4 d-grid">
                                    <button type="button" id="btn_select_patient" class="btn btn-success">Select Patient</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="btn_save_appointment" onclick="save_appointment()"
                        class="btn btn-success">Make Appointment</button>
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <button type="button" id="btn_new_patient" class="btn btn-success">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="btn_save_patient" onclick="save_patient()"
                        class="btn btn-success">Save Patient</button>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Intern\SAHANYA\resources\views/cashier/appointment/make_appointment.blade.php ENDPATH**/ ?>