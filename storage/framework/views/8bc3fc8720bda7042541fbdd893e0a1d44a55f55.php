...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        <!-- Dark Logo-->
        <a href="https://www.virtualseven.com/" class="logo logo-dark" target="blank">
            <span class="logo-sm">
                <img src="<?php echo e(URL::asset('images/favicon.png')); ?>" alt="" height="25">
            </span>
            <span class="logo-lg">
                <img src="<?php echo e(URL::asset('images/logo-white.png')); ?>" alt="" height="17">
            </span>
        </a>
        <!-- Light Logo-->
        <a href="https://www.virtualseven.com/" class="logo logo-light" target="blank">
            <span class="logo-sm">
                <img src="<?php echo e(URL::asset('images/favicon.png')); ?>" alt="" height="25">
            </span>
            <span class="logo-lg">
                <img src="<?php echo e(URL::asset('images/logo-white.png')); ?>" alt="" height="60">
            </span>
        </a>
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <?php if(Session::get('menu')=="management"): ?>
                ...
                <?php if(Session::get('menu')=="appointment"): ?>
...
<?php /**PATH D:\BIT\Project\Project\SAHANYA\SAHANYA\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>