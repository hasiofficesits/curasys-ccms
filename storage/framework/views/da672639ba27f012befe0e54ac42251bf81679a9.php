...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        var otable_group = $("#otable_group").DataTable({
            ...
            height: "40vh",
            ajax: {
                url: "<?php echo e(route('load_stock_group_grid')); ?>",
                method: "GET",
                data: function(d) {
                    $.extend(d, myData);
                }
        ...
        function save_group() {
            ...
            $.ajax({
                "url": "<?php echo e(route('save_new_group')); ?>",
                "method": "POST",
                "data": {
                    "group": group,
                    "code": code
        ...
        function update_group() {
            ...
            $.ajax({
                "url": "<?php echo e(route('update_stock_group')); ?>",
                "method": "POST",
                "data": {
                    "group_id": group_id,
                    "edit_code": edit_code,
        ...
        function active_group() {
            ...
            $.ajax({
                url:"<?php echo e(route('active_group_from_id')); ?>",
                method:"POST",
                data:{
                    "group_id":group_id
                },
        ...
        function inactive_group() {
            ...
            $.ajax({
                url:"<?php echo e(route('inactive_group_from_id')); ?>",
                method:"POST",
                data:{
                    "group_id":group_id
                },
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BIT\Project\Project\SAHANYA\CuraSys\resources\views/Stock/settings/stock_group.blade.php ENDPATH**/ ?>