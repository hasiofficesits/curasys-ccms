...
<?php $__env->startSection('content'); ?>
    ...
    <div id="add_store_item_modal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
        style="display: none;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header p-3 bg-light">
                    <h5 class="modal-title" id="myModalLabel">Add Store Item</h5>
                ...
                <div class="modal-body">
                        <div class="row g-2">
                            ...
                            <div class="col-lg-6">
                                <div class="row">
                                    <label for="colFormLabel" class="col-sm-4 col-form-label"><span class="text-danger">*</span>Critical Qty : </label>
                                    <div class="col-sm-8">
                                        <div id="ctrl_qty" class="form-control-sm"></div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- update_store_item_modal -->
    <div id="update_store_item_modal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
        style="display: none;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header p-3 bg-light">
                    <h5 class="modal-title" id="myModalLabel">Edit Stock Item</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"> </button>
                </div>
                <div class="modal-body">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-lg-6">
                                <div class="row">
                                    <label for="colFormLabel" class="col-sm-4 col-form-label"><span class="text-danger">*</span>Critical Qty : </label>
                                    <div class="col-sm-8">
                                        <div id="ctrl_qty_adjust" class="form-control-sm"></div>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        var otable_store_item = $("#otable_store_item").DataTable({
            processing: true,
            serverSide: true,
            responsive: false,
            scrollX: true,
            height:"40vh",
            ajax: {
                url: "<?php echo e(route('load_store_item')); ?>",
                method: "GET",
                data: function(d) {
                    $.extend(d, myData);
                }
            ...
            columns: [{
                ...
                //     render: function(data, type, row, meta) {
                //         // if (row.qty < data) {
                //         //     return '<span class="badge bg-danger p-2">Low</span>'
                //         // } else if (row.qty >= data) {
        ...
        $("#ctrl_qty").dxNumberBox({
            format: '#,##0.000',
            valueChangeEvent: "keyup",
        });
        $("#ctrl_qty_adjust").dxNumberBox({
            format: '#,##0.000',
            valueChangeEvent: "keyup",
        });
        ...
        $("#btn_add_store_item").on('click', function(){
            $("#add_store_item_modal").modal("show");
        });
        ...
        function add_item() {
            ...
            let ctrl_qty = $("#ctrl_qty").dxNumberBox('instance').option('value');
            ...
            $.ajax({
                "url": "<?php echo e(route('save_stock_item')); ?>",
                "method": "POST",
                "data": {
                    "name":name,
                    "code":code,
                ...
                "success": function(response) {
                    if (response.success) {
                        ...
                        otable_store_item.ajax.reload();
                        $("#add_store_item_modal").modal("hide");
        ...
        function clear_form() {
            ...
            $("#ctrl_qty").dxNumberBox("instance").option("value", 0);
        ...
        $('#otable_store_item tbody').on('click', '.btn-edit', function() {

            var data = otable_store_item.row($(this).parents('tr')).data();
            console.log(data);
            ...
            $("#ctrl_qty_adjust").dxNumberBox("instance").option("value", data.critical_level);

            $("#update_store_item_modal").modal("show");
        ...
        function update_item() {
            ...
            let ctrl_qty_adjust = $("#ctrl_qty_adjust").dxNumberBox("instance").option("value");

            $("#btn_update_item").attr('disabled', true);

            $.ajax({
                "url": "<?php echo e(route('update_stock_item')); ?>",
                "method": "POST",
                "data": {
                    "item_id":item_id,
                    ...
                    "ctrl_qty_adjust":ctrl_qty_adjust
                },
                "success": function(response) {
                    if (response.success) {
                        // console.log(data);
                        ...
                        otable_store_item.ajax.reload();
                        $("#update_store_item_modal").modal("hide");
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Intern\KARRS-Chamee\resources\views/stores/item_list.blade.php ENDPATH**/ ?>