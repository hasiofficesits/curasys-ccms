...
<?php $__env->startSection('title'); ?> Stock Dashboard <?php $__env->stopSection(); ?>
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span
                                            class="counter-value" data-target="<?php echo e($pharma_item_count); ?>"><?php echo e($pharma_item_count); ?></span>
                                    </h4>
                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span
                                            class="counter-value" data-target="<?php echo e($low_stock); ?>"><?php echo e($low_stock); ?></span></h4>
                                    <a href="/load_stock_item_page" class="text-decoration-underline">See details</a>
                                </div>
                                <div class="avatar-sm flex-shrink-0">
                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span
                                            class="counter-value" data-target="<?php echo e($out_of_stock_item_count); ?>"><?php echo e($out_of_stock_item_count); ?></span>
                                    </h4>
                                <a href="/load_stock_item_page" class="text-decoration-underline">See details</a>
                                </div>
                                <div class="avatar-sm flex-shrink-0">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">LKR <span
                                            class="counter-value" data-target="<?php echo e($get_invoice_total); ?>"><?php echo e(number_format($get_invoice_total, 2)); ?></span>
                                    </h4>
...
<script>
    ...
    function load_sales_to_chart() {
        $.ajax({
            url: "<?php echo e(route('load_sales_to_chart')); ?>",
            method: "GET",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\BIT\Project\Project\CuraSys\resources\views/Stock/dashboard.blade.php ENDPATH**/ ?>