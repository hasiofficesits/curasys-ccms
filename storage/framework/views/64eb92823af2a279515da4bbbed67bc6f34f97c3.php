        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-md-12">
                            <a href="<?php echo e(route('add_patient_page')); ?>" class="btn rounded-pill btn-md btn-success waves-effect waves-light">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Intern\SAHANYA\resources\views/management/patient/patient.blade.php ENDPATH**/ ?>