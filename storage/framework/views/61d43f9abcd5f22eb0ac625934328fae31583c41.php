            ...
            <div class="card">
                <div class="card-body">
                    <div class="row g-2">
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                <label for="colFormLabel" class="col-sm-2 ps-3 col-form-label">Item :</label>
                                <div class="col-sm-10">
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function load_item() {
            ...
            $.ajax({
                url: "<?php echo e(route('load_item_to_sum')); ?>",
                method: "GET",
                success: function(response) {
                    // console.log(response)
                    item = response.data
        ...
        var otable_outlet_order = $("#otable_outlet_order").DataTable({
            ...
            columns: [
                ...
                {
                    data: 'issue_head.date',
                    name: 'issue_head.date',
                },
                {
                    data: 'code',
                    name: 'code',
        ...
        $("#btn_load_report").on('click', function() {
            ...
            $.post('<?php echo e(route('load_item_sales_report')); ?>',
            {
                "outlet_id":outlet_id,
                "item_id":item_id,
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Intern\KARRS-Chamee\resources\views/reports/item_sales.blade.php ENDPATH**/ ?>