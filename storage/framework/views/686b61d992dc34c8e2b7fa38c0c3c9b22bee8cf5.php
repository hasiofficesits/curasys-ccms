...
<?php $__env->startSection('content'); ?>
    ...
    <!-- ask_sms_send_modal -->
    <div id="ask_sms_send_modal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
        style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header p-3 bg-light">
                    <h5 class="modal-title" id="myModalLabel">Send SMS Alert</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
                </div>
                <div class="modal-body">
                    <input type="hidden" id="app_id">
                    <h5 class="modal-title">Do You Want to Send SMS Alert for this Appointment ?</h5>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                    <button type="button" id="btn_send_sms" onclick="send_sms()" class="btn btn-success">Send</button>
                </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        // SMS Alert Function
        $('#otable_oppintment tbody').on('click', '.btn-send-sms', function() {

            var data = otable_oppintment.row($(this).parents('tr')).data();
            console.log(data);
            $("#app_id").val(data.ID);
            $("#ask_sms_send_modal").modal("show");
        });
        ...
        function send_sms() {
            ...
            $.ajax({
                url:"<?php echo e(route('send_sms_to_appointment')); ?>",
                method:"POST",
                data:{
                    "app_id":app_id
                },
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\BIT\Project\Project\CuraSys\resources\views/cashier/appointment/make_appointment.blade.php ENDPATH**/ ?>