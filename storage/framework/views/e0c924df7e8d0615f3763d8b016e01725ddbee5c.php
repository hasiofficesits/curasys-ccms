                ...
                <div class="card-body">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-4 mt-3 d-grid text-right">
                            <button id="btn_save_acc" onclick="save_acc()" class="btn btn-md btn-success">Update</button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Intern\SAHANYA\resources\views/management/acc_setting/acc_setting.blade.php ENDPATH**/ ?>