...
<?php $__env->slot('title'); ?> Stock Dashboard <?php $__env->endSlot(); ?>
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span
                                            class="counter-value" data-target="<?php echo e($stock_item_count); ?>">0</span>
                                    </h4>
                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span
                                            class="counter-value" data-target="<?php echo e($low_stock_count); ?>">0</span></h4>
                                    <a href="load_stock_item_page" class="text-decoration-underline">See details</a>
                                </div>
                                <div class="avatar-sm flex-shrink-0">
                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span
                                            class="counter-value" data-target="<?php echo e($out_of_stock_count); ?>">0</span>
                                    </h4>
                                <a href="load_stock_item_page" class="text-decoration-underline">See details</a>
                                </div>
                                <div class="avatar-sm flex-shrink-0">
                        ...
                        <div class="card-header align-items-center d-flex">
                            ...
                            <div class="flex-shrink-0">
                                <select class="form-select form-select-sm" id="productLotFilter" style="min-width: 200px;">
                                    ...
                                    <?php $__currentLoopData = $products_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($product->ID); ?>"><?php echo e($product->Pharma_name); ?></option>
...
<script>
    ...
    if (productSelect) {
        productSelect.addEventListener('change', function() {
            ...
            fetch("<?php echo e(route('get.lot.chart.data')); ?>?product_id=" + productId)
    ...
    if(dosageChartDom){
        var dosageLabels = <?php echo json_encode($dosageLabels, 15, 512) ?>;
        var dosageCounts = <?php echo json_encode($dosageCounts, 15, 512) ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\BIT\Project\Project\CuraSys\resources\views/stock/dashboard/stock-dashboard.blade.php ENDPATH**/ ?>