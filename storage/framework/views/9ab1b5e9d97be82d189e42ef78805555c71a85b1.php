            ...
            <tr class="font-reduce">
                <td width="50%" width="100%">
                    ...
                    <table style="margin-top:0px;" width="100%">
                        ...
                        <tr>
                            <td style="text-align: left;width:150px"><?php echo e($grn->grn_number); ?></td>
                            <td style="text-align: left"><?php echo e($grn->date); ?></td>
                            <td style="text-align: left"><?php echo e($grn->supplier->company); ?></td>
                            <td style="text-align: left"><?php echo e($grn->ref_no); ?></td>
                        </tr>
                        <tr></tr>
                        <tr></tr>
                    </table>
        ...
        <div style="page-break-after:auto;">
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $grn_body; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td style="text-align: right; width:80px;"><?php echo e($item->free_qty); ?></td>

                            <?php if($item->value): ?>
                                <td style="text-align: right"><?php echo e(number_format(floatval($item->value),  2, '.', ',')); ?></td>
                            <?php else: ?>
                                <td style="text-align: right"><?php echo e(number_format(0, 2, '.', ',')); ?></td>
                            <?php endif; ?>
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid #000;text-align: right;"><?php echo e(number_format($grn->total_value, 2, ".", ",")); ?></td>
                    </tr>
                    ...
                    <tr>
                        <td class="text-center" colspan="5" rowspan="1" style="padding-bottom:5px; text-align: right; border-bottom:1px solid #000; vertical-align: bottom;">
                            <span>Gross</span>
                        </td>

                        <?php if($grn->total_value): ?>
                            <td style="text-align: right; border-bottom:1px solid #000;"><?php echo e(number_format($grn->net_value, 2, ".", ",")); ?></td>
                        <?php else: ?>
            ...
            <table class="font-reduce" style="border: 1px solid #000" width="100%">
                <tr>
                    ...
                    <td>
                        <p>Cashier Details:</p>
                        <?php if($grn->create_by): ?>
                            <p>Prepared By: <?php echo e($grn->create_by); ?></p>
                        <?php else: ?>
                            <?php if(Auth::user()): ?>
...
<?php /**PATH D:\Intern\KARRS-Chamee\resources\views/pdf/grn_pdf.blade.php ENDPATH**/ ?>