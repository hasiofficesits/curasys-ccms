                        ...
                        <div class="col-lg-3">
                            <div class="row text-right">
                                ...
                                <div class="col-sm-7 d-grid">
                                    <button type="button" id="btn_add_toGrid" onclick="add_toGrid()" class="btn btn-info">Add</button>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Intern\SAHANYA\resources\views/Stock/return_note/return_note.blade.php ENDPATH**/ ?>