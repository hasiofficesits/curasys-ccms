                            ...
                            <div class="text-center mt-sm-5 pt-0">
                                <div class="mb-5 text-white-50">
                                    ...
                                    <div class="mt-4 pt-2">
                                        ...
                                        <a href="<?php echo e(route('load_cashier_view')); ?>" class="btn rounded-pill btn-lg btn-info btn-animation waves-effect waves-light me-2">
                                            <i class="las la-coins"></i> CASHIER</a>

                                        <a href="<?php echo e(route('load_report_view')); ?>" class="btn rounded-pill btn-lg btn-info btn-animation waves-effect waves-light">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\BIT\Project\Project\CuraSys\resources\views/menu_view.blade.php ENDPATH**/ ?>