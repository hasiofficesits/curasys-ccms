            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mt-sm-5 mb-0 text-white-50">
                        <div>
                            <a href="https://www.virtualseven.com/" class="d-inline-block auth-logo" target="blank">
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Sign in to continue to Sahanya Medical Center.</p>
                            </div>
                            <?php if(session('fail')): ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> VSS. Crafted with <i class="mdi mdi-heart text-danger"></i> by VSS (PVT) Ltd.</p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Intern\SAHANYA\resources\views/auth/login.blade.php ENDPATH**/ ?>