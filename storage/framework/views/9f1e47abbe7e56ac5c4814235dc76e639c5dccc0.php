                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group row mb-1">
                                <label for="did" class="col-sm-3 col-form-label col-form-label">ID :</label>
                                <div class="col-sm-9 ">
                        ...
                        <div class="col-md-4">
                            <div class="form-group row mb-1">
                                <label for="did" class="col-sm-3 col-form-label col-form-label">NIC
                                    :</label>
                                <div class="col-sm-9 ">
                                    <input type="text" class="form-control form-control" id="nic_number"
                                        value="<?php echo e($customer->Nic); ?>" placeholder="NIC Number">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group row mb-1">
                                <label for="did" class="col-sm-3 col-form-label col-form-label">Pass.No
                                    :</label>
                                <div class="col-sm-9 ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6  p-1">
                            ...
                            <div class="form-group row mb-1">
                                <label for="title" class="col-sm-3 col-form-label col-form-label">Name<span
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control form-control"
                                                id="name" placeholder="Name" value="<?php echo e($customer->FullName); ?>">
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row mb-1">
                                <label for="dob" class="col-sm-3 col-form-label col-form-label">Date Of
                                    Birth</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row mb-1">
                                <label for="email"
                                    class="col-sm-3 col-form-label col-form-label">Email</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row mb-1">
                                <label for="email"
                                    class="col-sm-3 col-form-label col-form-label">Religion</label>
                                <div class="col-sm-9">
                        ...
                        <div class="col-md-6  p-1">
                            ...
                            <div class="form-group row mb-1">
                                <label for="gender"
                                    class="col-sm-3 col-form-label col-form-label">Gender</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row mb-1">
                                <label for="email"
                                    class="col-sm-3 col-form-label col-form-label">Age</label>
                                <div class="col-sm-9">
                                    <div class="row">
                                        <div class="col">
                            ...
                            <div class="form-group row mb-1">
                                <label for="dob" class="col-sm-3 col-form-label col-form-label">Marital
                                    Status</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row mb-1">
                                <label for="dob"
                                    class="col-sm-3 col-form-label col-form-label">Active</label>
                                <div class="col-sm-9">
                                    <div id="isActive"></div>
                    ...
                    <div class="row">
                        <div class="col-md-6  p-1">
                            ...
                            <div class="form-group row mb-0">
                                <label for="did"
                                    class="col-sm-3 col-form-label col-form-label">Address</label>
                                <div class="col-sm-9 ">
                                    <input type="text" class="form-control form-control" id="address"
                                        placeholder="Address" value="<?php echo e($customer->Address); ?>">
                        ...
                        <div class="col-md-6  p-1">
                            ...
                            <div class="form-group row mb-1">
                                <label for="dob"
                                    class="col-sm-3 col-form-label col-form-label">Mobile<span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control" id="mobile"
                                        placeholder="Mobile Number" value="<?php echo e($customer->Mobile); ?>">
                    ...
                    <div class="row">
                        <div class="col-md-5  p-1">
                            <div class="form-group row mb-1">
                                <label for="dob" class="col-sm-4 col-form-label col-form-label">Guardian
                                    Name</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control" id="guardner_name"
                                        placeholder="Guardner Name" value="<?php echo e($customer->GardnerName); ?>">
                        ...
                        <div class="col-md-3  p-1">
                            ...
                            <div class="form-group row mb-0">
                                <label for="did" class="col-sm-4 col-form-label col-form-label">Contact</label>
                                <div class="col-sm-8 ">
                                    <input type="text" class="form-control form-control"
                                        id="guardner_contact_no" placeholder="Contact Number"
                                        value="<?php echo e($customer->GardnerContact); ?>">
                        ...
                        <div class="col-md-4  p-1">
                            ...
                            <div class="form-group row mb-0">
                                <label for="did"
                                    class="col-sm-4 col-form-label col-form-label">Relationship</label>
                                <div class="col-sm-8 ">
                                    <input type="text" class="form-control form-control"
                                        id="guardner_relationship" placeholder="Relationship with guardner"
                                        value="<?php echo e($customer->GardnerRelationShip); ?>">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-2 p-1">
                            <div class="form-check">
                                <?php if($customer->DebtorLedger == null): ?>
                                    <input class="form-check-input" type="checkbox" value="" id="debtor_ledger">
                                    <label class="form-check-label" for="debtor_ledger"> Debtor Ledger</label>
                                <?php else: ?>
                                    <input class="form-check-input" type="checkbox" value="" id="debtor_ledger" checked>
                                    <label class="form-check-label" for="debtor_ledger"> Debtor Ledger</label>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-2 p-1">
                            <div class="form-check">
                                <?php if($customer->AdvanceLedger == null): ?>
                                    <input class="form-check-input" type="checkbox" value="" id="advance_ledger">
                                    <label class="form-check-label" for="advance_ledger"> Advance Ledger</label>
                                <?php else: ?>
                                    <input class="form-check-input" type="checkbox" value="" id="advance_ledger" checked>
                                    <label class="form-check-label" for="advance_ledger"> Advance Ledger</label>
                                <?php endif; ?>
                        ...
                        <div class="col-md-2 p-1 text-right">
                            <button class="btn btn-md btn-secondary" onclick="history.back();">Back</button>
                            <button id="btnUpdate_Patient" class="btn btn-md btn-primary"
                                onclick="update_patient()">Save</button>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        $("#title").val("<?php echo e($customer->Title); ?>");
        $("#religion").val("<?php echo e($customer->Religion); ?>");
        $("#maritalStatus").val("<?php echo e($customer->CivilStatus); ?>");
        $("#pass_no").val("<?php echo e($customer->pass_no); ?>");
        ...
        var birthDay = "<?php echo e($customer->BirthDay); ?>";
        ...
        console.log('<?php echo e($customer->BirthDay); ?>')

        $("#dob").dxDateBox({
            displayFormat: 'yyyy-MMM-dd',
            value: "<?php echo e($customer->BirthDay); ?>",
        ...
        function set_age() {
            var fdob = "<?php echo e($customer->BirthDay); ?>";
            const date = moment(fdob, 'YYYY-MM-DD');
        ...
        function update_patient() {
            ...
            data = {
                'patient_id': <?php echo e($customer->ID); ?>,
            ...
            $("#btnUpdate_Patient").attr("disabled", true);

            $.ajax({
                url: "<?php echo e(route('ajax_update_patient')); ?>",
                method: 'POST',
                data: data,
                success: function(response) {
                    if (response.success) {
                        ...
                        clear_form()
                        // $("#btnUpdate_Patient").attr("disabled", false);
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Intern\SAHANYA\resources\views/management/patient/update.blade.php ENDPATH**/ ?>