    ...
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <div class="row g-2">
                        <input type="hidden" class="form-control" id="appointment_id" value="{{ $appointment->ID }}">
                        <input type="hidden" class="form-control" id="que_id" value="{{ $que_id }}">
                        <div class="col-lg-6">
                            <div class="row">
                                <label for="colFormLabel" class="col-sm-3 col-form-label">Appointment :</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="que_id" value="{{ $appointment->ID }}"
                                        disabled>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="doctor"
                                        value="{{ $appointment->doctor->Name }}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="patient_name"
                                        value="{{ $appointment->patient->FullName }}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="type"
                                        value="{{ $appointment->Pt_Table }}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="complaint"
                                        value="{{ $appointment->Complain }}" disabled>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="prescription" role="tabpanel"
                            ...
                            {{-- <table id="otable_prescription" class="display" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Name</th>
                        ...
                        <div class="tab-pane fade show" id="note" role="tabpanel" aria-labelledby="note-tab">
                            <br>
                            {{-- <table id="otable_note" class="display" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Note</th>
            ...
            <div class="modal-content">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show" id="add_opdservice" role="tabpanel"
                            ...
                            {{-- <div class="row g-2 mt-3">
                                <div class="col-lg-4">
                                    <div class="row">
                                        <label for="colFormLabel" class="col-sm-4 ps-3 col-form-label">Consultant fee :</label>
                                        <div class="col-sm-6">
                                            <div id="cons_fee" class="form-control-sm"></div>
                                        </div>
                                        <div class="col-sm-2">
                                            <button type="button" id="btn_save_cons_fee" class="btn btn-info">Add</button>
                                        </div>
                                    </div>
                                </div>
                            </div> --}}
                ...
                <div class="modal-footer">
                    ...
                    {{-- <button type="button" id="btn_save_invoice" onclick="save_invoice()"
                        class="btn btn-success">Save Invoice</button> --}}
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-2">
                        ...
                        {{-- <div class="col-lg-12">
                            <div class="row">
                                <label for="colFormLabel" class="col-sm-2 col-form-label">Lot :</label>
                                <div class="col-sm-10">
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                <label for="colFormLabel" class="col-sm-3 col-form-label">Avl.Qty:</label>
                                <div class="col-sm-9">
...
@section('script')
    ...
    <script>
        ...
        function load_frequency() {
            $.ajax({
                url: "{{ route('load_frequency_appoi') }}",
                method: "GET",
                success: function(response) {
                    // console.log(response)
        ...
        function load_service_details() {
            ...
            $.ajax({
                url: "{{ route('load_service_details') }}",
                method: "POST",
                "data": {
        ...
        function view_result_body() {
            ...
            $.post('{{ route('load_result_bodyHistory') }}', {
                "result_ID": result_ID
            },
            function(res) {
                ds_result_Bodyview = [];
        ...
        function load_exist_data() {
            ...
            $.ajax({
                url: "{{ route('load_exist_appointment_details') }}",
                method: "POST",
                "data": {
        ...
        function save_service() {
            ...
            $.ajax({
                "url": "{{ route('save_opd_service_appointment') }}",
                "method": "POST",
                "data": {
                    "app_id": app_id,
                    "body_data": body_data,
