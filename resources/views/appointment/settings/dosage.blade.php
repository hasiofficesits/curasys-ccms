...
@section('script')
    ...
    <script>
        ...
        var otable_dosage_list = $("#otable_dosage_list").DataTable({
            ...
            height: "40vh",
            ajax: {
                url: "{{ route('load_Dosage_unit_list') }}",
                method: "GET",
                data: function(d) {
                    $.extend(d, myData);
                }
        ...
        function inactive_unit() {
            ...
            $.ajax({
                url:"{{ route('inactive_dosage_list') }}",
                method:"POST",
                data:{
                    "act_unit_id":act_unit_id
                },
        ...
        function save_unit() {
            ...
            $.ajax({
                "url": "{{ route('save_new_dosage_unit') }}",
                "method": "POST",
                "data": {
                    "unit_name": unit_name
                },
        ...
        function update_unit() {
            ...
            $.ajax({
                "url": "{{ route('update_new_dosage_unit') }}",
                "method": "POST",
                "data": {
                    "name": name,
                    "id":id
