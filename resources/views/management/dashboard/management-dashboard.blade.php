...
@slot('title') Management Dashboard @endslot
@endcomponent
<div class="row">
    <div class="col">
                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="{{ $doctor_count }}">0</span></h4>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="{{ $patient_count }}">0</span></h4>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="{{ $opd_service_count }}">0</span></h4>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="{{ $user_count }}">0</span></h4>
...
<script>
    ...
    if(yearFilter) {
        yearFilter.addEventListener('change', function() {
            ...
            fetch("{{ route('get.patient.chart.data') }}?year=" + selectedYear)
    ...
    if(specialityDom){
        ...
        var specialityLabels = @json($specialityLabels);
        var specialityCounts = @json($specialityCounts);
