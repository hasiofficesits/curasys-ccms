...
@section('script')
    ...
    <script>
        ...
        //     $.ajax({
        //         url: "{{ route('load_rev_acc_service') }}",
        //         method: "GET",
        ...
        var otable_service = $("#otable_service").DataTable({
            ...
            height: "40vh",
            ajax: {
                url: "{{ route('load_opdservice_grid') }}",
                method: "GET",
                data: function(d) {
                    $.extend(d, myData);
                }
        ...
        function active_service() {
            ...
            $.ajax({
                url:"{{ route('active_service_from_id') }}",
                method:"POST",
                data:{
        ...
        function inactive_service() {
            ...
            $.ajax({
                url:"{{ route('inactive_service_from_id') }}",
                method:"POST",
                data:{
                    "act_service_id":act_service_id
                },
