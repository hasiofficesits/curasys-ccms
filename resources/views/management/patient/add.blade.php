                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row mb-1">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    {{-- <input type="date" class="form-control form-control" id="dob" placeholder="Email"> --}}
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row mb-1">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    {{-- <input type="time" class="form-control form-control" value="05:00" id="email" placeholder="Email"> --}}
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-1">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    {{-- <input type="number" class="form-control form-control" id="dob" placeholder="Fee"> --}}
                                </div>
                            </div>

                            {{-- <div class="form-group row mb-1">
                                <label for="gender" class="col-sm-3 col-form-label ">Medi. Council No</label>
                                <div class="col-sm-9">
                                    <div id="medicalCouncilNumber" class="form-control"></div>
