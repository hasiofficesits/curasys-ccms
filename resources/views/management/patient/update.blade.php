            ...
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="form-group row mb-1">
                                ...
                                <div class="col-sm-9 ">
                                    <input type="number" class="form-control form-control" id="did"
                                        value="{{ $patient_next_id }}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group row mb-1">
                                ...
                                <div class="col-sm-9 ">
                                    <input type="text" class="form-control form-control" id="nic_number"
                                        value="{{ $customer->Nic }}" placeholder="NIC Number">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-6  p-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control form-control"
                                                id="name" placeholder="Name" value="{{ $customer->FullName }}">
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row mb-1">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    {{-- <input type="date" class="form-control form-control-sm" id="dob" placeholder="Email"> --}}
                                </div>
                            </div>
                        ...
                        <div class="col-md-6  p-1">
                            ...
                            <div class="form-group row mb-1">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    {{-- <input type="time" class="form-control form-control-sm" value="05:00" id="email" placeholder="Email"> --}}
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-1">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    {{-- <input type="number" class="form-control form-control-sm" id="dob" placeholder="Fee"> --}}
                                </div>
                            </div>

                            {{-- <div class="form-group row mb-1">
                                <label for="gender" class="col-sm-3 col-form-label col-form-label-sm">Medi. Council No</label>
                                <div class="col-sm-9">
                                    <div id="medicalCouncilNumber" class="form-control-sm"></div>
                            ...
                            <div class="form-group row mb-1">
                                ...
                                <div class="col-sm-9">
                                    <div id="isActive"></div>
                                    {{-- <input type="text" class="form-control form-control-sm" id="dob" placeholder="Mobile Number"> --}}
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-1">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control" id="guardner_name"
                                        placeholder="Guardner Name" value="{{ $customer->GardnerName }}">
                            ...
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-8 ">
                                    <input type="text" class="form-control form-control"
                                        ...
                                        value="{{ $customer->GardnerRelationShip }}">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-2 p-1">
                            <div class="form-check">
                                @if ($customer->AdvanceLedger == null)
                        ...
                        <div class="col-md-2 p-1 text-right">
                            ...
                            {{-- <a id="btnUpdate_Patient" class="btn btn-sm btn-primary" onclick="update_patient()">Save</a> --}}
                            {{-- <a class="btn btn-sm btn-primary">Save and New</a> --}}
                        </div>
                    </div>
                </div>
            </div>
...
@section('script')
    ...
    <script>
        ...
        $("#religion").val("{{ $customer->Religion }}");
        $("#maritalStatus").val("{{ $customer->CivilStatus }}");
        $("#pass_no").val("{{ $customer->pass_no }}");
