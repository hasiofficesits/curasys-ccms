        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-md-12">
                            <a href="{{ route('add_patient_page') }}" class="btn rounded-pill btn-md btn-primary waves-effect waves-light">
