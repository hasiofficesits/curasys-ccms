                    ...
                    <div class="row g-2">
                        ...
                        {{-- <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="edit_password" placeholder="Enter password">
                                </div>
                            </div>
                        </div> --}}
                        <div class="col-lg-12">
                        ...
                        {{-- <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div id="edit_user_type" class="form-control-sm"></div>
                                </div>
                            </div>
                        </div> --}}
...
@section('script')
    ...
    <script>
                        ...
                        success: function (response) {
                            ...
                            $('#doctor_select').dxSelectBox({
                                ...
                                onValueChanged: function (ev) {
                                    ...
                                    $.ajax({
                                        url: "{{ route('load_selected_doctors_data') }}",
                                        method: "POST",
                                        data: {
                                            doctor_id: doctor_id,
        ...
        function inactive_user() {
            ...
            $.ajax({
                url:"{{ route('inactive_user_from_id') }}",
                method:"POST",
                data:{
                    "act_user_id":act_user_id
                },
