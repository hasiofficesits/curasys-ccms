                    ...
                    <div class="text-center mt-sm-5 mb-0 text-white-50">
                        <div>
                            <a href="#" class="d-inline-block auth-logo" target="blank">
                                <img src="{{ URL::asset('images/logo-white.png')}}" alt="" height="80">
                            </a>
                        </div>
                    </div>
                </div>
                                ...
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                            <input type="password" class="form-control pe-5 @error('password') is-invalid @enderror" name="password" placeholder="Enter password">
