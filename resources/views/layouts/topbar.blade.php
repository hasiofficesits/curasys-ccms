        ...
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                <div class="ms-1 header-item d-none d-sm-flex me-3">
                    <a href="{{ route('menu_view') }}" class="btn btn-success btn-icon waves-effect waves-light">
                        <i class="ri-home-4-line"></i>
                    </a>
                </div>

                <div class="ms-1 mt-3 header-item d-none d-sm-flex me-2">
                    <p>Hello!!, <span class="fw-semibold me-3">{{ Auth::user()->name }}</span>| <span
                            class="badge bg-primary p-2 ms-3"><i class="las la-calendar me-1"></i>System Date :</span>
                        {{ now()->format('d M, Y') }} <span class="badge bg-warning p-2 ms-3">System Time : </span><span
