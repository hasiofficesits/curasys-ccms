            ...
            <tr class="font-reduce">
                <td width="50%" width="100%">
                    ...
                    <table style="margin-top:0px;" width="100%">
                        ...
                        <tr>
                            <td style="text-align: left;width:150px">{{ $grn->Grid }}</td>
                            <td style="text-align: left">{{ $grn->Date }}</td>
                            <td style="text-align: left">{{ $grn->supplier->Company }}</td>
                            <td style="text-align: left">{{ $grn->RefInv }}</td>
                        </tr>
                        <tr></tr>
                        <tr></tr>
                    </table>
                ...
                <tbody>
                    ...
                    @foreach ($grn_body as $item)
                        <tr>
                            ...
                            <td style="text-align: right; width:40px">{{ $item->DisCount }}</td>
                            <td style="text-align: right; width:80px;">{{ $item->FreeQty }}</td>

                            @if ($item->UnitCost)
                                <td style="text-align: right">{{ number_format(floatval($item->UnitCost),  2, '.', ',') }}</td>
                            @else
                                <td style="text-align: right">{{ number_format(0, 2, '.', ',') }}</td>
                            @endif
                    ...
                    @endforeach
                            ...
                            @if(count($grn_body)<=15)
                                @for ($i = 0; $i < 15-count($grn_body); $i++)
                                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid #000;text-align: right;">{{ number_format($grn->Total, 2, ".", ",") }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid #000;text-align: right;">{{ number_format($grn->Discount, 2, ".", ",") }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        @if ($grn->Gross)
                            <td style="text-align: right; border-bottom:1px solid #000;">{{ number_format($grn->Gross, 2, ".", ",")  }}</td>
                        @else
            ...
            <table class="font-reduce" style="border: 1px solid #000" width="100%">
                <tr>
                    ...
                    <td>
                        ...
                        @endif
                        <p>Date Time: </p>
                        <p>{{ date('d-m-Y', strtotime($grn->Date)) }}</p>
                    </td>
                </tr>
