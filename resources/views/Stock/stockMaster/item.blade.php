                    ...
                    <div class="row g-2">
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="code" value="{{ $next_code }}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
...
@section('script')
    ...
    <script>
        ...
        function load_supplier() {
            $.ajax({
                url: "{{ route('load_supplier_to_stock') }}",
                method: "GET",
        ...
        function load_category() {
            $.ajax({
                url: "{{ route('load_category_to_stock') }}",
                method: "GET",
                success: function(response) {
                    // console.log(response)
        ...
        var otable_stk_item = $("#otable_stk_item").DataTable({
            ...
            height: "40vh",
            ajax: {
                url: "{{ route('load_stock_item_grid') }}",
                method: "GET",
                data: function(d) {
                    $.extend(d, myData);
                }
        ...
        function save_item() {
            ...
            $.ajax({
                "url": "{{ route('add_pharmacy_stock_item') }}",
                "method": "POST",
                "data": {
                    "code": code,
                    "phm_name": phm_name,
        ...
        function update_item() {
            ...
            $.ajax({
                "url": "{{ route('update_pharmacy_stock_item') }}",
                "method": "POST",
                "data": {
                    "edit_code": edit_code,
        ...
        $('#otable_stk_item tbody').on('click', '.btn-add', function() {
            ...
            $.post('{{ route('load_stock_lot_grid') }}',
            {
        ...
        function update_lot() {
            ...
            $.ajax({
                "url": "{{ route('update_phm_stock_lot') }}",
                "method": "POST",
                // processData:false,
                "data": {
                    "lot_id":lot_id,
        ...
        function delete_lot() {
            ...
            $.ajax({
                "url": "{{ route('delete_phm_stock_lot') }}",
                "method": "POST",
                // processData:false,
                "data": {
        ...
        function inactive_item() {
            ...
            $.ajax({
                url:"{{ route('inactive_item_from_id') }}",
                method:"POST",
                data:{
                    "item_id":item_id
                },
