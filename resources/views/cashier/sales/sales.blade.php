                    ...
                    <div class="row g-2">
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="{{ $next_inv_no }}" id="next_invoice" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        {{-- <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div id="type" class="form-control-sm"></div>
                                </div>
                            </div>
                        </div> --}}
                        <hr>
...
@section('script')
    ...
    <script>
        ...
        function load_customer() {
            $.ajax({
                url: "{{ route('load_customer_to_invoice') }}",
                method: "GET",
                success: function(response) {
                    // console.log(response)
