...
@section('script')
    ...
    <script>
        ...
        var otable_patient = $("#otable_patient").DataTable({
            ...
            height:"40vh",
            ajax: {
                url: "{{ route('load_patient_select_grid') }}",
                method: "GET",
                data: function(d) {
                    $.extend(d, myData);
                }
        ...
        function save_patient() {
            ...
            $.ajax({
                "url": "{{ route('save_patient_in_oppointment') }}",
                "method": "POST",
                "data": {
                    "gender":gender,
                    "name": name,
        ...
        function send_sms() {
            ...
            $.ajax({
                url:"{{ route('send_sms_to_appointment') }}",
                method:"POST",
                data:{
                    "app_id":app_id
                },
