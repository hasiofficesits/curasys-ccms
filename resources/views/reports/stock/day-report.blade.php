                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-2">
                            ...
                            <input class="form-control form-control-sm" type="date" id="report_date" value="{{ date('Y-m-d') }}">
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadReport() {
                ...
                $.ajax({
                    url: '{{ route("load_day_report_grid") }}',
                    method: 'GET',
                    data: {
            ...
            $('#btn_exportReport').click(function() {
                ...
                window.location.href = '{{ route("export_day_report_excel") }}' + 
                    '?from_date=' + reportDate + 
                    '&to_date=' + reportDate;
            });
