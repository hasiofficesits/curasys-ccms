                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-2">
                            ...
                            <input class="form-control form-control-sm" type="date" id="from_date" value="{{ date('Y-m-01') }}">
                        </div>
                        <div class="col-lg-2">
                            <label for="to_date" class="col-form-label">To Date</label>
                            <input class="form-control form-control-sm" type="date" id="to_date" value="{{ date('Y-m-d') }}">
                        </div>
                        <div class="col-lg-2">
